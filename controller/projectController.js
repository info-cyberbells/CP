...
import Employee from '../model/employeeModel.js'; // Assuming you have an Employee model
import Status from '../model/statusModel.js'; // Assuming you have a Status model
import Technology from '../model/technologyModel.js'; // Assuming you have a Technology model

console.log('Inside project controller');

export const addProject = async (req, res) => {
    try {
        const { name, description, clientName, clientAddress, assignedTo, department, status, remarks, startDate, deliveryDate, urls, technology } = req.body;
        ...
        // Ensure assignedTo and technology are arrays
        ...
        // Fetch technology names based on technology IDs
        ...
        // Fetch employee names based on assignedTo IDs
        ...
        // Fetch status details based on status IDs
        // Fetch status details based on status IDs
        ...
        // Fetch detailed project info after saving
...
export const fetchAllProjects = async (req, res) => {
    try {
        ...
        // Return the response in the same format as addProject
